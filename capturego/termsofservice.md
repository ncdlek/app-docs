...
- The App may include virtual currency (e.g., Coins) or items (e.g., Boosts, Themes).
- These items have no real-world value and cannot be redeemed for cash.
...
## 9. Changes to Terms
We may update these terms at any time. Continued use of the App constitutes acceptance of the changes.
